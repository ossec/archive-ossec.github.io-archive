...
.. raw:: html
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
              <div class="panel panel-default">
                  <div class="panel-heading"><h3>Everywhere</h3></div>
    ...
    <section class="bg-2">
      <div class="col-sm-10 col-sm-offset-1 text-center">
        <h1>Host Intrusion Detection For Everyone</h1>
      </div>
    </section>
        ...
        <div class="row">
            <div class="col-md-4">
              <div class="panel panel-default">
                ...
                <div class="panel-body">OSSEC is fully open source and free for your use. You can tailor OSSEC for
            ...
            <div class="col-md-4">
              <div class="panel panel-default">
                ...
                <div class="panel-body">OSSEC helps customers meet specific compliance requirements as outlined 
            ...
            <div class="col-md-4">
              <div class="panel panel-default">
                <div class="panel-heading"><h3>Support</h3></div>
                <div class="panel-body">OSSEC is supported by a large community of developers, IT admins and
    ...
    <section class="bg-3 text-center">
      <h1>Trusted By Security Vendors And IT Departments</h1>
      <p class="lead"></p>
    </section>
    <!--/parallax 2-->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
              <div class="panel panel-default">
                <div class="panel-heading"><h3><a href="https://www.alienvault.com/">AlienVault</a></h3></div>
                <div class="panel-body">The AlienVault Unified Security Management™ (USM) platform provides five 
