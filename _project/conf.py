...
project = u'OSSEC'
copyright = u'2010-2015, OSSEC Project Team - OSSEC trademark and domain owned by Trend Micro, Inc. - Home page images courtesy of Pixbay.com'
...
html_theme_options = {
    ...
    'navbar_links': [
        ...
        ('Documentaton <i class="fa fa-book"></i>', "http://ossec-docs.readthedocs.org/en/latest/", 1),
    ],
